...
class Activity extends CI_Controller{
    ...
    public function gotoActivitylist(){

        $data['list'] = $this->mactivity->getActivitylist();

        $data['act_goal_list'] = $this->mcategory->getCategoryList("ActGoal");
        $data['act_fundingSources_list'] = $this->mcategory->getCategoryList("ActFundingSource");
    ...
    public function filter(){
        ...
        $fundingSourcesID = $this->input->post('FundingSourcesID');
        ...
        $data['list'] = $this->mactivity->getActivitylistWithFilter(
            $startDate,
            $startTime,
            $endDate,
            $endTime,
    ...
    public function gotoAddActivity($error = '') {
...
/*
    public function gotoAddActivityWithError($error) {
...
*/
    public function gotoEditActivity($error = '') {
...
/*
    public function gotoEditActivityWithError($error) {
...
*/
    public function addActivity() {
        ...
        if(!gf_cu_rightsActivityAdd()) redirect('/error');
    ...
    public function editActivity() {
        ...
        if(!gf_cu_rightsActivityEdit()) redirect('/error');
    ...
    public function deleteActivity()
    {
        ...
        if(!gf_cu_rightsActivityDelete()) redirect('/error');
