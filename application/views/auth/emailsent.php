				...
				<div class="login-block">
					<form role="form" action="index.html">
						<?php
							...
							if($found == "true") {
								echo '
									<h4 style = "color: white;text-align: center;font-size: 30pt;font-weight: 500;padding-bottom: 20px;">Password Reset</h4>
									<p style = "color: white;text-align: center;font-weight: 500;padding-bottom: 20px;">A password reset link has been sent to <b>'.$emailAddress.'</b>. <br /> Check your inbox!</p>';
							} else {
								echo '
									<h4 style = "color: white;text-align: center;font-size: 30pt;font-weight: 500;padding-bottom: 20px;">Password Reset</h4>
									<p style = "color: white;text-align: center;font-weight: 500;padding-bottom: 20px;">Sorry, we could not find your account with the email <b>'.$emailAddress.'</b>.</p>';
							}
						?>
