        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-sitemap'></i> School Management</h1>
            		<h3></h3>            	</div>
											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="toolbar-btn-action">
														<a class="btn btn-success" href="/schools/gotoAddSchool"><i class="fa fa-plus-circle"></i> Add new</a>
													</div>
												</div>
											</div>
										</div>';
										...
										<?php
											...
											foreach($list as $school) {
												...
												<tr>
													...
													<td><span class="label label-success">'.$school->schoolStatus.'</span></td>
													<td>
                                                        <div class="btn-group btn-group-xs">
															<a data-toggle="tooltip" title="Details" class="btn btn-default" href="/schools/gotoEditSchool?school_id='.$school->school_id.'" '.$edit_btn_disabled.'><i class="fa fa-edit"></i></a>
														</div>
                                                    </td>
												</tr>
												';
