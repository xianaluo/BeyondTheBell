						...
						<div class="col-sm-12">
							<div class="widget widget-tabbed">
								...
								<ul class="nav nav-tabs nav-justified">
									<li class="active"><a href="#about" data-toggle="tab"><i class="fa fa-sitemap"></i> ADD SCHOOL</a></li>
								</ul>
								<!-- End nav tab -->

								<!-- Tab panes -->
								<div class="tab-content">
									<form role="form" action="/schools/addSchool" method="post" id="registerForm" enctype="multipart/form-data">
											...
											<div class="row">
												<div class="col-sm-6">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" id="SchoolName" name="SchoolName" placeholder="" value="<?php echo set_value('SchoolName'); ?>">
													</div>
													<div class="form-group">
														...
														<select class="form-control" id="SchoolType" name="SchoolType">
															...
															foreach($schooltype_list as $schooltype) {
																if(set_value('SchoolType') == $schooltype->cate_name) {
													...
													<div class="form-group">
														...
														<select class="form-control" id="ParentSchool" name="ParentSchool">
															...
															foreach($list as $school) {
																if(set_value('ParentSchool') == $school->school_id) {
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" id="Principal" name="Principal" placeholder="" value="<?php echo set_value('Principal'); ?>">
													</div>
													<div class="form-group">
														<label for="exampleInputEmail1">Building Coordinator</label>
														<input type="text" class="form-control" id="BuildingCoordinator" name="BuildingCoordinator" placeholder="" value="<?php echo set_value('BuildingCoordinator'); ?>">
													</div>
													<div class="form-group">
														<label for="exampleInputEmail1">School Code</label>
														<input type="text" class="form-control" id="SchoolCode" name="SchoolCode" placeholder="" value="<?php echo set_value('SchoolCode'); ?>">
													</div>
													<div class="form-group">
														<label for="exampleInputEmail1">School Enrollment</label>
														<input type="text" class="form-control" id="SchoolEnrollment" name="SchoolEnrollment" placeholder="" value="<?php echo set_value('SchoolEnrollment'); ?>">
													</div>
												...
												<div class="col-sm-6">
													...
													<div class="form-group">
														...
														<input type="text" class="form-control" id="FaxNumber" name="FaxNumber" placeholder="" value="<?php echo set_value('FaxNumber'); ?>">
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<select class="selectpicker" multiple data-selected-text-format="count>3" id="AttachingActivities[]" name="AttachingActivities[]" >
															...
															foreach($activity_list as $activity) {
																...
																if( set_value('AttachingActivities')[$activity->activity_id] ) {
