		...
		<div class="full-content-center">
			...
			<div class="login-wrap animated flipInX">
				<div class="login-block">
					<form role="form" action="/auth/emailtoreset" method="post" id="registerForm" name="registerForm">
						<h4 style = "color: white;text-align: center;font-size: 30pt;font-weight: 500;padding-bottom: 20px;">Insert Your Email</h4>
						<div class="form-group login-input">
						<i class="fa fa-user overlay"></i>
						<input type="email" class="form-control text-input" placeholder="Email" id="EmailAddress" name="EmailAddress">
						</div>
						<div class="row">
							<div class="col-sm-12">
