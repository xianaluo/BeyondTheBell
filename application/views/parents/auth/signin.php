...
<html>
    <head>
        ...
        <link rel="apple-touch-icon" sizes="152x152" href="<?= asset_base_url()?>/img/apple-touch-icon-152x152.png" />
  		...
  		html { 
		  background: url(/images/kid.jpg) no-repeat center center fixed;
    ...
    <body class="fixed-left login-page" style = " background-image: url('/images/kid.jpg');">
        <!-- Modal Start -->
        	<!-- Modal Task Progress -->	
		...
		<div class="full-content-center">
			...
			<div class="login-wrap animated flipInX">
				...
				<div class="login-block">
					<form role="form" action="/parents/auth/signin" method="post" id="registerForm" name="registerForm">
						<div class="form-group login-input">
						<i class="fa fa-user overlay"></i>
						<input type="email" name="EmailAddress" id="EmailAddress" class="form-control text-input" placeholder="Email" value="<?php echo set_value('EmailAddress'); ?>">
						</div>
						<div class="form-group login-input">
						<i class="fa fa-key overlay"></i>
						<input type="Password" name="Password" class="form-control text-input" placeholder="********" value="<?php echo set_value('Password'); ?>">
						<a href = "/auth/gotoForgotpw">Forgot Password</a>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<input type="hidden" name="type" value="0"/>
								<a href="/parents/auth/signup" class="btn btn-danger btn-block">SIGNUP</a>
							</div>
