...
<html>
	...
	?>
	<!-- ChangeBillingModal -->
	<div id="ChangeBillingModal" name="ChangeBillingModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="modal-body ">
					<div class="widget-content padding form-horizontal">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeBilling_Address1" name="ChangeBilling_Address1" value="<?= $Billing_Address1?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Address2: </label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeBilling_Address2" name="ChangeBilling_Address2" value="<?= $Billing_Address2?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">City: </label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeBilling_City" name="ChangeBilling_City" value="<?= $Billing_City?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">State: </label>
							<div class="col-sm-9">
								<select class="form-control" id="ChangeBilling_State" name="ChangeBilling_State">
									<?php
										foreach($arr_state as $state) {
											if($Billing_State == $state->cate_id)
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeBilling_ZipCode" name="ChangeBilling_ZipCode" value="<?= $Billing_ZipCode?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Phone Number: </label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeBilling_PhoneNumber" name="ChangeBilling_PhoneNumber" value="<?= $Billing_PhoneNumber?>">
							</div>
						</div>
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-success" data-dismiss="modal" id="ChangeBilling_ApplyBtn" name="ChangeBilling_ApplyBtn">Apply</button>
				...
				<div class="modal-body ">
					<div class="widget-content padding form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 control-label">Address1: </label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeAddress_Address1" name="ChangeAddress_Address1" value="<?= gf_cu_address1()?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Address2: </label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeAddress_Address2" name="ChangeAddress_Address2" value="<?= gf_cu_address2()?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">City: </label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeAddress_City" name="ChangeAddress_City" value="<?= gf_cu_city()?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">State: </label>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label">Zip Code: </label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeAddress_ZipCode" name="ChangeAddress_ZipCode" value="<?= gf_cu_zipCode()?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label">Phone Number: </label>
							<div class="col-sm-9">
								<input type="text" class="form-control" id="ChangeAddress_PhoneNumber" name="ChangeAddress_PhoneNumber" value="<?= gf_cu_phoneNumber()?>">
							</div>
						</div>
						<div class="form-group">
	...
	<div id="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<form id="registerForm" name="registerForm" method="post" action="/parents/billing/pay">
				<div class="widget invoice" id="InvoiceContents" name="InvoiceContents">
					...
					<div class="bill-to">
						<div class="row">
							<div class="col-sm-6">
								<h4><strong><?= gf_cu_fullName()?></strong></h4>
								<address>
									<span id="LabelAddress" name="LabelAddress"><?= gf_cu_address1()?> <?php if(gf_cu_address2()) echo gf_cu_address2(); ?></span><br>
									<span id="LabelCityStateZip" name="LabelCityStateZip"><?= gf_cu_city()?>, <?= gf_cu_state() ?>, <?= gf_cu_zipCode() ?></span><br>
									<span id="LabelPhoneNumber" name="LabelPhoneNumber"><?= gf_cu_phoneNumber()?></span><br>
					...
					<input type="hidden" id="Address1" name="Address1" value="<?= gf_cu_address1() ?>">
					<input type="hidden" id="Address2" name="Address2" value="<?= gf_cu_address2() ?>">
					<input type="hidden" id="City" name="City" value="<?= gf_cu_city() ?>">
					<input type="hidden" id="State" name="State" value="<?= gf_cu_state() ?>">
					<input type="hidden" id="ZipCode" name="ZipCode" value="<?= gf_cu_zipCode() ?>">
					<input type="hidden" id="PhoneNumber" name="PhoneNumber" value="<?= gf_cu_phoneNumber() ?>">
...
?>
		...
		$(document).ready(function() {
			...
			$("#DiscountVerifyBtn").click(function() {
				...
				var get_url = "/parents/billing/verifyDiscount?code=" + code;
			...
			$("#ChangeAddress_ApplyBtn").click(function(){
				...
				if(document.getElementById("ChangeAddress_ApplyProfile").checked) {
					...
					var get_url = "/parents/profile/updateAddress?address1=" + address1 + "&address2=" + address2 + "&city=" + city + "&state=" + state + "&zipCode=" + zipCode + "&phoneNumber=" + phoneNumber;
