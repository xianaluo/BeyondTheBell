						...
						<div class="widget widget-tabbed">
							...
							<ul class="nav nav-tabs nav-justified">
								<?php
									...
									if($complete) {
										echo '<li class="active"><a href="#about" data-toggle="tab"><i class="fa fa-user"></i> Your Profile</a></li>';
									} else {
										echo '<li class="active"><a href="#about" data-toggle="tab"><i class="fa fa-user"></i> Please complete your profile!</a></li>';
									}
							...
							<div class="tab-content">
								...
								<div class="tab-pane animated active fadeInRight" id="about">
									...
									<form role="form" action="/parents/profile/update" method="post" enctype="multipart/form-data" id="registerForm" name="registerForm">
