									...
									<table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
										<thead>
											<tr>
                                                ...
                                                <th>Status</th>
                                                <th>Type</th>
												<th data-sortable="false">Chat   </th>
										...
										<?php
                                            if(gf_cu_rightsEdit() || gf_cu_rightsChat()) {
                                                $edit_btn_disabled = " ";
                                            } else {
											...
											foreach($userlist as $user) {
												...
												<tr>
                                                    ...
                                                    <td>'.$user->unreadMsg.'</td>
													<td>
                                                        <div class="btn-group btn-group-xs">
                                                            <a data-toggle="tooltip" title="Details" class="btn btn-default" href="/user/gotoEditUser?user_id='.$user->user_id.'" '.$edit_btn_disabled.'><i class="fa fa-edit"></i></a>
                                                        </div>
                                                    </td>
												</tr>
												';
