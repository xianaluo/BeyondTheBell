		...
		<div class="content-page">
			...
			<div class="content">
				...
				<div class="page-heading">
					<h1><i class='fa fa-laptop'></i> Create Discount</h1>
				</div>
				<?php
				...
				if($error || validation_errors()) {
					...
					if(set_value("AmountPercent")=="Amount")
						$TakeOffLabel = "$";
					else if(set_value("AmountPercent")=="Percent")
						$TakeOffLabel = "%";
				...
				<div class="row">
					<div class="col-md-12 portlets">
						...
						<div class="widget animated fadeInDown">
							...
							<form id="myWizard" name="myWizard" method="post" action="/discount/insert">
										...
										<div class="col-sm-6">
											<div class="row">
												<div class="form-group col-sm-10">
													...
													<input type="text" id="DiscountName" name="DiscountName" class="form-control" value = "<?php echo set_value("DiscountName"); ?>">
												</div>
											</div>
											<div class="row">
												<div class="form-group col-sm-10">
													<label >Discount Code</label>
													<input type="text" id="DiscountCode" name="DiscountCode" class="form-control" value = "<?php echo set_value("DiscountCode"); ?>">
												</div>
											</div>
											<div class="row">
												<div class="form-group col-sm-10">
													<label >How many times can this discount be used?</label>
													<input type="text" id="DiscountLimit" name="DiscountLimit" class="form-control"  <?php echo $DiscountLimit_disabled; ?> value = "<?php echo set_value("DiscountLimit"); ?>">
												</div>
											</div>
											<div class="row">
												<div class="form-group col-sm-10">
											...
											<div class="row">
												<div class="form-group col-sm-10">
													...
													<input type="text" id="DiscountDesc" name="DiscountDesc" class="form-control"  value = "<?php echo set_value("DiscountDesc"); ?>">
												</div>
											</div>
										</div>
								...
								<section class="step" data-step-title="Discount type">
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="row">
												<div class="form-group col-sm-10">
													...
													<select class="form-control" name="AmountPercent" id="AmountPercent">
														<option value="Amount" <?php if(set_value("AmountPercent")=="Amount") echo "selected"; ?>>$USD</option>
														<option value="Percent" <?php if(set_value("AmountPercent")=="Percent") echo "selected"; ?>>%Discount</option>
													</select>
												</div>
											</div>
											<div class="row">
												<div class="form-group col-sm-10">
													...
													<input type="text" id="TakeOff" name="TakeOff" class="form-control" value="<?php echo set_value("TakeOff"); ?>">
												</div>
											</div>
											<div class="row">
												<div class="form-group col-sm-10">
													...
													<select class="form-control" id="OffFor" name="OffFor">
														<option value="ForAllUsers" <?php if(set_value("OffFor")=="ForAllUsers") echo "selected"; ?>>All users</option>
														<option value="ForSpecificUsers" <?php if(set_value("OffFor")=="ForSpecificUsers") echo "selected"; ?>>For specific users</option>
														<option value="ForSpecificTiers" <?php if(set_value("OffFor")=="ForSpecificTiers") echo "selected"; ?>>For specific tiers</option>
														<option value="ForMultipleChild" <?php if(set_value("OffFor")=="ForMultipleChild") echo "selected"; ?>>For multiple children</option>
														<option value="ForSpecificActivities" <?php if(set_value("OffFor")=="ForSpecificActivities") echo "selected"; ?>>For specific activities</option>
													</select>
												</div>
											</div>
											<div class="row" id="ForSpecificUsersDiv" name="ForSpecificUsersDiv" <?php if(set_value("OffFor")!="ForSpecificUsers") echo 'style="display: none"'; ?>>
												<div class="form-group col-sm-10">
													<select class="form-control selectpicker" id="ForSpecificUsers[]" name="ForSpecificUsers[]" multiple data-selected-text-format="count>3" data-size="5" data-live-search = "true">
														...
														foreach($user_list as $user) {
															...
															if( set_value('ForSpecificUsers')[$user->user_id] ) {
											...
											<div class="row" id="ForSpecificTiersDiv" name="ForSpecificTiersDiv" <?php if(set_value("OffFor")!="ForSpecificTiers") echo 'style="display: none"'; ?>>
												<div class="form-group col-sm-10">
													<select class="form-control selectpicker" id="ForSpecificTiers[]" name="ForSpecificTiers[]" multiple data-selected-text-format="count>3" data-size="auto">
														...
														foreach($tier_list as $item) {
															...
															if( set_value('ForSpecificTiers')[$item->cate_id] ) {
											...
											<div class="row" id="ForMultipleChildDiv" name="ForMultipleChildDiv" <?php if(set_value("OffFor")!="ForMultipleChild") echo 'style="display: none"'; ?>>
												<div class="form-group col-sm-10">
													<input type="text" id="ForMultipleChild" name="ForMultipleChild" class="form-control" value="<?php echo set_value("ForMultipleChild"); ?>">
												</div>
											</div>
											<div class="row" id="ForSpecificActivitiesDiv" name="ForSpecificActivitiesDiv" <?php if(set_value("OffFor")!="ForSpecificActivities") echo 'style="display: none"'; ?>>
												<div class="form-group col-sm-10">
													<select class="form-control selectpicker" id="ForSpecificActivities[]" name="ForSpecificActivities[]" multiple data-selected-text-format="count>3" data-size="5" data-live-search = "true">
														...
														foreach($activity_list as $activity) {
															...
															if( set_value('ForSpecificActivities')[$activity->activity_id] ) {
										...
										<div class="col-sm-6">
											...
											<div class="row">
												<div class="form-group col-sm-10">
													...
													<input type="text" id="ExpireDate" name="ExpireDate" class="form-control datepicker-input" <?php echo $ExpireDate_disabled?> value="<?php echo set_value("ExpireDate"); ?>">
												</div>
											</div>
											<div class="row">
												<div class="form-group col-sm-10">
											...
											<div class="row">
												<div class="form-group col-sm-10">
													...
													<select class="form-control" id="Status" name="Status">
														<option value="Not Live" <?php if(set_value("Status")=="Not Live") echo "selected"; ?>>Not Live</option>
														<option value="Live" <?php if(set_value("Status")=="Live") echo "selected"; ?>>Live</option>
													</select>
												</div>
											</div>
										</div>
