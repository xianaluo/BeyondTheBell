...
class Mmessagetemplate extends CI_Model {
        ...
        try {
            ...
            if($search_value) {
                ...
                for ($i = 0; $i < count($result); $i++) {
                    ...
                    $pos2 = strpos($description, $search_value);
                    $pos3 = strpos($contents, $search_value);
    ...
    public static function deleteTemplate($template_id)
    {
        try {
            ...
            $maker = $template_one->get("email");

            if($maker == gf_cu_email()) {
